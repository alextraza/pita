<div class="table-responsive">
    <table class="table-stripped data-table">
        ...
        <tr>
            ...
            <td>{{ $model->slug }}</td>
            <td>{{ $model->header }}</td>
            <td>@include('admin.grid.status', ['path' => 'category'])</td>
            ...
            <td>
                <div class="action-field">
                    ...
                    <a href="{{ route('category.edit', ['id' => $model->id]) }}">
