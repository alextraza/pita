    ...
    <div class="breadcrumb-top">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="{{ route('page.index') }}">Страницы</a>
                </li>
                <li>
                    <span>Изменить</span>
                </li>
...
@section('content')
    <div class="dock">
        <form method="POST" id="createCategory" action="{{ route('page.post', ['id' => $model->id]) }}" enctype="multipart/form-data">
            @method('POST')
            @csrf
            <div class="dock__header dock__header--fill">
                <a class="btn btn--red" href="{{ route('page.index') }}">Отменить</a>
                <div class="flex">
