<div class="table-responsive">
    <table class="table-stripped data-table">
        ...
        <tr>
            ...
            <td>{{ $model->id }}</td>
            <td>@include('admin.grid.position', ['path' => 'page'])</td>
            <td>{{ $model->slug }}</td>
            <td>{{ $model->header }}</td>
            ...
            <td>
                <div class="action-field">
                    ...
                    <a href="{{ route('page.edit', ['id' => $model->id]) }}">
