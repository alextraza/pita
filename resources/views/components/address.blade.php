<form id="addressForm" method="post" class="form__group__add user__address__form"
    ...
    <div class="form__field__add street @error('street') has-error @enderror">
        ...
        <input id="street" type="text" name="street" value="{{ old('street', $model->street ?? '') }}">
        @error('street')
    ...
    <div class="form__field__add house  @error('house') has-error @enderror">
        ...
        <input id="house" type="text" name="house" value="{{ old('house', $model->house ?? '') }}">
        @error('house')
    ...
    <div class="form__field__add appartment @error('apartment') has-error @enderror">
        ...
        <input id="appartment" type="text" name="apartment" value="{{ old('apartment', $model->apartment ?? '') }}">
        @error('apartment')
    ...
    <div class="form__field__add entrance @error('entrance') has-error @enderror">
        ...
        <input id="entrance" type="text" name="entrance" value="{{ old('entrance', $model->entrance ?? '') }}">
        @error('entrance')
    ...
    <div class="form__field__add floor @error('floor') has-error @enderror">
        ...
        <input id="floor" type="text" name="floor" value="{{ old('floor', $model->floor ?? '') }}">
        @error('floor')
        <span class="text-danger">{{ $errors->first('floor') }}</span>
        @enderror
    </div>
    <div class="form__field__add client-code @error('code') has-error @enderror">
        <label for="client-code">Код домофона</label>
        <input id="client-code" type="text" name="code" value="{{ old('floor', $model->code ?? '') }}">
        @error('code')
