...
Route::post('recover', [AuthController::class, 'passwordRecovery'])->name('recovery.user');
...
Route::post('/user', [FrontendController::class, 'userSave'])->name('user.save');
...
Route::get('/payment', [CheckoutController::class, 'payment_ret'])->name('payment_ret');
